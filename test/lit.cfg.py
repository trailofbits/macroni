...
tools = [
    ToolSubst(
        "kernelize",
        os.path.join(config.macroni_obj_root, "bin", "Kernelize", "Debug", "kernelize"),
    ),
    ToolSubst(
        "kernelcheck",
        os.path.join(
            config.macroni_obj_root, "bin", "KernelCheck", "Debug", "kernelcheck"
        ),
        extra_args=["--kernelcheck"],
    ),
    ToolSubst(
        "macronify",
        os.path.join(config.macroni_obj_root, "bin", "Macronify", "Debug", "macronify"),
    ),
    ToolSubst(
        "safe-c",
        os.path.join(config.macroni_obj_root, "bin", "SafeC", "Debug", "safe-c"),
    ),
