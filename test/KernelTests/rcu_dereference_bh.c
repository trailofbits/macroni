...
// CHECK:         %3 = kernel.rcu_dereference_bh(%2) : (!hl.lvalue<!hl.ptr<!hl.int>>) -> !hl.ptr<!hl.typeof.expr<"(*(x))">>
...
// CHECK:         %7 = kernel.rcu_dereference_bh(%6) : (!hl.lvalue<!hl.ptr<!hl.char>>) -> !hl.ptr<!hl.typeof.expr<"(*(s->begin))">>
