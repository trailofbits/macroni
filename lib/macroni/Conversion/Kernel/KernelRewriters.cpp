...
//       exp, exp.getType(0),
//       std::forward<ReplacementArgs>(replacement_args)...);
//   return true;
// }
...
//     return mlir::failure();
//   }
//   auto [rcu_ptr, ptr, c] = fetch_macro_parameters(exp, "rcu_ptr", "ptr",
//   "c"); if (!((rcu_ptr && rcu_ptr->getNumResults() == 1) &&
//         (ptr && ptr->getNumResults() == 1) && (c && c->getNumResults() ==
//         1))) {
//     return mlir::failure();
//   }
...
//       exp, exp.getType(0), rcu_ptr_clone->getResult(0),
//       ptr_clone->getResult(0), c_clone->getResult(0));
//   return mlir::success();
// }
